...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php $this->Url->build(['controller' => 'Page', 'action' => 'home']); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="blog" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/articles/posts">
                            Posts
                        </a>
                        <a class="collapse-item" href="/articles/categories">
                            Categorias
                        </a>
                    </div>
                </div>
